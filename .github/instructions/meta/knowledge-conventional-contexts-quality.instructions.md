...
Rules for writing and updating `*AGENTS.md` files. Applies whenever you create or modify an AGENTS.md — including Phase 8 (Handover) updates. Updated: 2026-02-28
