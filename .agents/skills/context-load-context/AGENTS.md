...
- Created files come from `.agents/templates/TEMPLATE_AGENTS.md` and are deliberately left minimal — population happens in Phase 8 (Handover), so don't "improve" creation to pre-fill sections.
