...
| 1 | Discovery | 🛑 GATE | Consolidate domain/technical/test clarifications | Orchestrator + PO + Architect + QA (parallel) |
| 2 | Analysis | | Analyze tech stack, determine tech requirements, identify patterns | Architect |
| 3 | Specification | | Create technical specification with architectural decisions | Architect |
| 4 | Planning | 🛑 GATE | Present implementation plan + module breakdown | Architect → Backend/Frontend engineers (parallel) |
| 5 | Documentation | | Update AGENTS.md with approved plan under `## Requirements` | Architect |
| 6 | Implementation | | 🔨 YOLO MODE — implement autonomously on shared branch | Backend/Frontend engineers (parallel) |
| 7 | Verification | | Quality gate — spec/implementation sync check | Architect + Backend/Frontend engineers + QA (parallel) |
| 8 | Handover | 🛑 MANDATORY | Document actual implementation, commit all work | Orchestrator |
...
## Phase 1: Discovery — Orchestrator Multi-Agent Pattern
...
## Phase 2: Analysis — Architect Only (Sonnet)

**Prerequisite:** Phase 1 consolidated clarifications approved by user.

**Architect responsibilities:**

1. **Determine technology stack requirements** — This output directly informs Phase 4 (Planning) sub-agent selection:
...
## Phase 3: Specification — Architect Only (Opus)
...
## Phase 4: Planning — Architect (Opus) → Backend/Frontend Engineers (Sonnet)
...
## Phase 5: Documentation — Architect Only (Sonnet)
...
## Phase 6: Implementation — Backend/Frontend Engineers (Sonnet) in Parallel
...
## Phase 7: Verification — Architect (Opus) + Engineers (Sonnet) + QA (Sonnet) in Parallel
...
## Phase 8: Handover — Orchestrator (Opus) Commits All Work
